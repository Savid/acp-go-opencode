...
const (
	...
	// ViolationUnknownField refuses any unknown member of the negotiation
	// object, the envelope, an event, or a correlation value.
	...
	// ViolationStaleStream refuses an event from an incarnation already fenced
	// or superseded.
	...
	// ViolationImmutableIdentityChange refuses an update that changes an
	...
	// ViolationLateCausalWork refuses a first-sight activity whose origin turn
	// or parent activity was first seen at or before a certified watermark.
