...
func TestAgentStandaloneCovMarkerRefusesEveryMalformedPayload(t *testing.T) {
	...
	for index := 0; index < 129; index++ {
		manyPaths = append(manyPaths,
			`{"base":"/srv/opencode","segments":["p`+strconv.Itoa(index)+`"],"action":"revoke-path","rootDev":1,"rootIno":1}`,
		)
	}
	for _, testCase := range []struct {
		...
		},
		{
			...
			payload: agentStandaloneCovActiveMarker(uid, gid, "k", lease,
				`[{"base":"/srv/opencode","segments":["a"],"action":"revoke-path","rootDev":1}]`,
			),
		...
		},
		{
			...
			payload: agentStandaloneCovActiveMarker(uid, gid, "k", lease,
				`[{"base":"/srv/opencode","segments":["a"],"action":"revoke-path","rootDev":1,"rootIno":0}]`,
			),
		...
		},
		{
			...
			payload: agentStandaloneCovActiveMarker(uid, gid, "k", lease,
				`[{"base":"/srv/opencode","segments":["a"],"action":"revoke-path","rootDev":1,"rootIno":1},`+
					`{"base":"/srv/opencode","segments":["a"],"action":"revoke-tree","rootDev":1,"rootIno":1}]`,
			),
			want: `marker path "/srv/opencode/a" is duplicated with actions "revoke-path" and "revoke-tree"`,
		},
		{
			name: "removal overlapping a retained subtree",
			payload: agentStandaloneCovActiveMarker(uid, gid, "k", lease,
				`[{"base":"/srv/opencode","segments":["a"],"action":"remove-path","rootDev":1,"rootIno":1},`+
					`{"base":"/srv/opencode","segments":["a","b"],"action":"revoke-path","rootDev":1,"rootIno":1}]`,
			),
			want: `marker removal path "/srv/opencode/a/b" conflicts with "/srv/opencode/a"`,
		},
	} {
...
func TestAgentStandaloneCovMarkerAcceptsDisjointManifestPaths(t *testing.T) {
	...
	agentStandaloneCovWriteRegistryFile(t, directory, "62303.quarantine",
		agentStandaloneCovActiveMarker(uid, gid, "disjoint", "0123456789abcdef0123456789abcdef",
			`[{"base":"/srv/opencode","segments":["a"],"action":"remove-path","rootDev":7,"rootIno":8},`+
				`{"base":"/srv/opencode","segments":["b"],"action":"revoke-tree","rootDev":7,"rootIno":8}]`,
		),
	)
...
func TestAgentStandaloneCovManifestPathValidation(t *testing.T) {
	valid := agentStandaloneManifestPath{
		Base: "/srv/opencode", Segments: []string{"a"}, Action: agentStandaloneCovRevokePath, RootDev: 1, RootIno: 2,
	}
	...
	for _, testCase := range []struct {
		...
		},
		{
			name: "no segments",
			path: agentStandaloneManifestPath{
				Base: "/srv/opencode", Segments: nil, Action: agentStandaloneCovRevokePath, RootDev: 1, RootIno: 2,
			},
		...
		},
		{
			name: "no root device",
			path: agentStandaloneManifestPath{
				Base: "/srv/opencode", Segments: []string{"a"}, Action: agentStandaloneCovRevokePath, RootDev: 0, RootIno: 2,
			},
			want: "manifest path is incomplete",
		},
		{
			...
			path: agentStandaloneManifestPath{
				Base: "/srv/opencode", Segments: []string{parentPathSegment}, Action: agentStandaloneCovRevokePath, RootDev: 1, RootIno: 2,
			},
		...
		},
		{
			...
			path: agentStandaloneManifestPath{
				Base: "/srv/opencode", Segments: []string{"a/b"}, Action: agentStandaloneCovRevokePath, RootDev: 1, RootIno: 2,
			},
			want: "manifest path segment is invalid",
		},
		{
			...
			path: agentStandaloneManifestPath{
				Base: "/srv/opencode", Segments: []string{"a\x01b"}, Action: agentStandaloneCovRevokePath, RootDev: 1, RootIno: 2,
			},
		...
		},
		{
			name: "unknown action",
			path: agentStandaloneManifestPath{
				Base: "/srv/opencode", Segments: []string{"a"}, Action: "delete-everything", RootDev: 1, RootIno: 2,
			},
...
func TestAgentStandaloneCovOwnerRecordRefusesNonCanonicalAndInvalidBindings(t *testing.T) {
	...
	canonical := agentStandaloneOwner{
		...
		StateRoot: agentStandaloneStateRoot{Path: "/srv/opencode/canonical", Dev: 5, Ino: 6},
	}
	...
	controlStateRoot.StateRoot.Path = "/srv/opencode/\x01"
	...
	for _, testCase := range []struct {
		...
		{
			name:    "missing field",
			payload: `{"version":1,"uid":62311,"gid":62312,"kind":"standalone-provider","provider":"github.com/savid/acp-go-opencode","ownerId":"x"}` + "\n",
		...
		},
		{
			...
			payload: `{"version":1,"uid":62311,"gid":62312,"kind":"standalone-provider",` +
				`"provider":"github.com/savid/acp-go-opencode","ownerId":"x",` +
				`"stateRoot":{"path":"/srv/opencode/x","dev":1,"ino":2,"extra":3}}` + "\n",
		...
		},
		{
			...
			payload: `{"version":1,"uid":"62311","gid":62312,"kind":"standalone-provider",` +
				`"provider":"github.com/savid/acp-go-opencode","ownerId":"x",` +
				`"stateRoot":{"path":"/srv/opencode/x","dev":1,"ino":2}}` + "\n",
