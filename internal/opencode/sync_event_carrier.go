...
// from native session events before they enter portable storage. The adapter
// stores the carrier independently of native metadata and installs a fresh
// reference only after exact replay verification.
