...
docs-audit:
	...
	@for flag in -path -home -scratch-dir -model -debug -version -seed-file -opencode-pure -opencode-question-tool -opencode-log-level -opencode-version -opencode-health-timeout; do rg -q -- "$$flag" docs/reference/cli.mdx cmd/acp-go-opencode/main.go || { echo "missing CLI flag in docs/code: $$flag"; exit 1; }; done
