...
docs-audit:
	...
	@for flag in path home scratch-dir provider-auth-root provider-auth-direct-home model debug version seed-file opencode-direct-api opencode-pure opencode-question-tool opencode-log-level opencode-health-timeout plugin-seed-dir no-plugin-seed; do \
