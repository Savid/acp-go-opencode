...
// incarnation per native binding generation, the foreground it currently holds,
...
// on the first record opencode produced for the turn, the prompt does it when the
