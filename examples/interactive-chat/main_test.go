...
func TestChatUIAndSessionUpdates(t *testing.T) {
	...
	require.Contains(t, text, "opencode> agent text")
...
func TestRawInputKeepsToolAndStreamingMessageOrder(t *testing.T) {
	...
	requireLineOrder(t, frame,
		...
		"opencode> answer with more detail",
		"status> thinking",
		"message> ",
	)
	require.NotContains(t, frame, "opencode> answer\r\nopencode> answer with more detail")
}
...
func TestChatUIRenderingBranches(t *testing.T) {
	...
	require.Contains(t, text, "opencode> with redraw")
	require.Contains(t, text, "opencode> ")
	require.Contains(t, text, "stop> end_turn")
...
func TestRawUIUpdatesUsageToolsAndSpinner(t *testing.T) {
	...
	require.Contains(t, raw.String(), "opencode> late agent")
...
func TestRunPrompt(t *testing.T) {
	...
	require.Contains(t, output.String(), "opencode> ")
